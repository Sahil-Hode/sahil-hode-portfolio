...
export default function Contact() {
  ...
  if (portfolioLoading || !data) return null;
  ...
  const socialLinks = [
    { icon: <FaLinkedin />, label: "LinkedIn", link: socials.linkedin },
    { icon: <FaGithub />, label: "GitHub", link: socials.github },
    { icon: <FaWhatsapp />, label: "WhatsApp", link: socials.whatsapp }
  ].filter(s => s.link);
      ...
      <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", marginBottom: "40px" }} className="justify-center lg:justify-start">
          <div style={{ 
            ...
            <span style={{ fontSize: "12px", fontWeight: 800, color: "#A3FF12", textTransform: "uppercase", letterSpacing: "0.1em" }}>{contact.availability}</span>
          </div>
        </div>
              ...
              <div style={{ 
                ...
                <div style={{ display: "flex", gap: "20px", alignItems: "center" }}>
                  ...
                  <div>
                    ...
                    <p style={{ color: "#a1a1aa", fontSize: "14px", marginBottom: "4px" }}>{contact.email}</p>
                    <p style={{ color: "#A3FF12", fontSize: "11px", fontWeight: 800, textTransform: "uppercase" }}>Replies within 24hrs</p>
                  </div>
                </div>
                <button 
                  onClick={() => handleCopy(contact.email, "Email")}
                  style={{ background: "transparent", border: "none", color: copied === "Email" ? "#A3FF12" : "#71717a", cursor: "pointer" }}
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div style={{ 
                  ...
                  <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
                    ...
                    <div>
                      ...
                      <p style={{ color: "#a1a1aa", fontSize: "13px", margin: 0 }}>{contact.phone}</p>
                    </div>
                  </div>
                  <button onClick={() => handleCopy(contact.phone, "Phone")} style={{ background: "transparent", border: "none", color: "#71717a", cursor: "pointer" }}>
                ...
                <div style={{ 
                  ...
                  <div>
                    ...
                    <p style={{ color: "#a1a1aa", fontSize: "13px", margin: 0 }}>{contact.location}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div style={{ 
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "24px", width: "100%" }}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <input required type="text" value={formData.name} onChange={(e) => setFormData({...formData, name: e.target.value})} placeholder="Your Name" style={{ background: "#1a1a1a", border: "1px solid rgba(255,255,255,0.1)", padding: "18px 20px", borderRadius: "14px", color: "#fff", outline: "none", fontSize: "15px", width: "100%" }} />
                <input required type="email" value={formData.email} onChange={(e) => setFormData({...formData, email: e.target.value})} placeholder="Email Address" style={{ background: "#1a1a1a", border: "1px solid rgba(255,255,255,0.1)", padding: "18px 20px", borderRadius: "14px", color: "#fff", outline: "none", fontSize: "15px", width: "100%" }} />
              </div>
              <textarea required value={formData.message} onChange={(e) => setFormData({...formData, message: e.target.value})} placeholder="Your Message" rows={5} style={{ background: "#1a1a1a", border: "1px solid rgba(255,255,255,0.1)", padding: "18px 20px", borderRadius: "18px", color: "#fff", outline: "none", fontSize: "15px", resize: "none", width: "100%" }} />
               <button type="submit" disabled={loading} style={{ background: "#A3FF12", color: "#000", padding: "18px", borderRadius: "14px", fontWeight: 900, textTransform: "uppercase", cursor: "pointer", transition: "all 0.3s ease" }}>
