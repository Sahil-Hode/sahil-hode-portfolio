"use client";
 ...
 import { HiOutlineLocationMarker, HiOutlineCalendar, HiChevronRight } from "react-icons/hi";
 ...
 export default function About() {
   const specialties = [
     { 
       ...
       desc: "LangChain, RAG pipelines, n8n workflow automation for real-world AI solutions.",
       icon: <TbBrain />
     },
     { 
       title: "Full Stack Engineering", 
       desc: "End-to-end apps with Next.js, React, Node.js, Express & MongoDB/PostgreSQL.",
       icon: <TbCode />
     },
     { 
       title: "Cloud & DevOps", 
       desc: "AWS deployment, Docker, GitHub Actions CI/CD pipelines — 95% fewer deploy errors.",
       icon: <TbCloudCode />
     },
     { 
       title: "Mobile Development", 
       desc: "Flutter & Dart cross-platform apps with optimized API integration.",
       icon: <TbDeviceMobile />
     },
     { 
       title: "Database Engineering", 
       desc: "Scalable data architecture with MongoDB, MySQL & PostgreSQL.",
       icon: <TbDatabase />
     },
     { 
       title: "Performance Optimization", 
       desc: "Fast, SEO-ready, production-grade code built for scale and real impact.",
       icon: <TbRocket />
     }
   ];
           ...
           <div className="lg:col-span-4 flex flex-col items-center lg:items-start text-center lg:text-left">
             ...
             <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginBottom: "32px" }}>
               <div style={{ 
                 ...
                 <HiOutlineLocationMarker size={18} color="#A3FF12" /> Thane, Mumbai, Maharashtra
               </div>
               <div style={{ 
                 background: "rgba(255,255,255,0.03)", padding: "14px 20px", borderRadius: "14px", border: "1px solid rgba(255,255,255,0.05)",
                 display: "flex", alignItems: "center", gap: "12px", fontSize: "14px", fontWeight: 600, color: "#e4e4e7"
               }}>
                 <HiOutlineCalendar size={18} color="#A3FF12" /> BCA 2024-2027
               </div>
             </div>
 
             {/* Social Icon Buttons */}
             <div style={{ display: "flex", gap: "12px", marginBottom: "40px" }}>
               <a href="https://github.com/Sahil-Hode" target="_blank" rel="noopener noreferrer" style={{
               ...
               <a href="https://www.linkedin.com/in/sahil-hode" target="_blank" rel="noopener noreferrer" style={{
                 width: "48px", height: "48px", borderRadius: "12px", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)",
                 display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontSize: "20px", transition: "all 0.3s ease"
               }} className="glow-hover">
                 <FaLinkedin />
             ...
             <div style={{ 
               ...
               <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                 ...
                 <div style={{ fontSize: "14px", fontWeight: 700, color: "#fff" }}>• 2nd Place — Invento Competition</div>
               </div>
             </div>
           </div>
